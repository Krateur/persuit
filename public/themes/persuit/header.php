...
<head>
    ...
    <link rel="icon" href="<?= get_theme_file_uri('img/fav-icon.png') ?>" type="image/x-icon" />
   <?php wp_head(); ?>
</head>
<body>
                ...
                <div class="top_header_left">
                    <div class="selector">
                        <select class="language_drop" name="countries" id="countries" style="width:300px;">
                            <option value='yt' data-image="<?= get_theme_file_uri('img/icon/flag-1.png') ?>" data-imagecss="flag yt" data-title="English">English</option>
                            <option value='yu' data-image="<?= get_theme_file_uri('img/icon/flag-1.png') ?>" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                            <option value='yt' data-image="<?= get_theme_file_uri('img/icon/flag-1.png') ?>" data-imagecss="flag yt" data-title="English">English</option>
                            <option value='yu' data-image="<?= get_theme_file_uri('img/icon/flag-1.png') ?>" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                        </select>
                    </div>
...
<header class="shop_header_area">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#"><img src="<?= get_theme_file_uri('img/logo.png') ?>" alt=""></a>
