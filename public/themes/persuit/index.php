        ...
        <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
            <ul>
                <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="img/home-slider/slider-1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="<?= get_theme_file_uri('img/home-slider/slider-1.jpg') ?>"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    ...
                    <div class="slider_text_box">
                        <div class="tp-caption tp-resizeme first_text"
                             ...
                             style="z-index: 8;font-family: Montserrat,sans-serif;font-weight:700;color:#29263a;"><img src="<?= get_theme_file_uri('img/home-slider/2017-text.png') ?>" alt=""></div>
        ...
        <div class="row feature_inner">
            <div class="col-lg-5">
                <div class="f_add_item">
                    <div class="f_add_img"><img class="img-fluid" src="<?= get_theme_file_uri('img/feature-add/f-add-1.jpg') ?>" alt=""></div>
            ...
            <div class="col-lg-4">
                <div class="f_add_item right_dir">
                    <div class="f_add_img"><img class="img-fluid" src="<?= get_theme_file_uri('img/feature-add/f-add-2.jpg') ?>" alt=""></div>
                    <div class="f_add_hover">
                        <h4>Best Summer <br />Collection</h4>
                        <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                    </div>
            ...
            <div class="col-lg-3">
                <div class="f_add_item">
                    <div class="f_add_img"><img class="img-fluid" src="<?= get_theme_file_uri('img/feature-add/f-add-3.jpg') ?>" alt=""></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="l_product_slider owl-carousel">
            <div class="item">
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-1.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                ...
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-5.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
            ...
            <div class="item">
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-2.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-6.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
            ...
            <div class="item">
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-3.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-7.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
            ...
            <div class="item">
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-4.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="l_product_item">
                    <div class="l_p_img">
                        <img src="<?= get_theme_file_uri('img/product/l-product-8.jpg') ?>" alt="">
                    </div>
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="f_add_item white_add">
                    <div class="f_add_img"><img class="img-fluid" src="<?= get_theme_file_uri('img/feature-add/f-add-4.jpg') ?>" alt=""></div>
                    <div class="f_add_hover">
                        <h4>Best Summer <br />Collection</h4>
                        <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="f_add_item white_add">
                    <div class="f_add_img"><img class="img-fluid" src="<?= get_theme_file_uri('img/feature-add/f-add-5.jpg') ?>" alt=""></div>
                    <div class="f_add_hover">
                        <h4>Best Summer <br />Collection</h4>
                        <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                    </div>
        ...
        <div class="row p_listing_inner">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-4">
                        <div class="p_list_img">
                            <img src="<?= get_theme_file_uri('img/product/p-categories-list/product-l-1.jpg') ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-4">
                        <div class="p_list_img">
                            <img src="<?= get_theme_file_uri('img/product/p-categories-list/product-l-2.jpg') ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-4">
                        <div class="p_list_img">
                            <img src="<?= get_theme_file_uri('img/product/p-categories-list/product-l-3.jpg') ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="f_product_left">
                        ...
                        <div class="f_product_inner">
                            <div class="media">
                                <div class="d-flex">
                                    <img src="<?= get_theme_file_uri('img/product/featured-product/f-p-1.jpg') ?>" alt="">
                                </div>
                            ...
                            <div class="media">
                                <div class="d-flex">
                                    <img src="<?= get_theme_file_uri('img/product/featured-product/f-p-2.jpg') ?>" alt="">
                                </div>
                                <div class="media-body">
                                    <h4>Puffer Jacket</h4>
                                    <h5>$45.05</h5>
                            ...
                            <div class="media">
                                <div class="d-flex">
                                    <img src="<?= get_theme_file_uri('img/product/featured-product/f-p-3.jpg') ?>" alt="">
                                </div>
                                <div class="media-body">
                                    <h4>Leather Bag</h4>
                                    <h5>$45.05</h5>
                            ...
                            <div class="media">
                                <div class="d-flex">
                                    <img src="<?= get_theme_file_uri('img/product/featured-product/f-p-4.jpg') ?>" alt="">
                                </div>
                                <div class="media-body">
                                    <h4>Casual Shoes</h4>
                                    <h5>$45.05</h5>
                        ...
                        <div class="fillter_slider owl-carousel">
                            <div class="item shoes">
                                <div class="fillter_product_item bags">
                                    <div class="f_p_img">
                                        <img src="<?= get_theme_file_uri('img/product/fillter-product/f-product-1.jpg') ?>" alt="">
                            ...
                            <div class="item woman shoes bags">
                                <div class="fillter_product_item">
                                    <div class="f_p_img">
                                        <img src="<?= get_theme_file_uri('img/product/fillter-product/f-product-2.jpg') ?>" alt="">
                                        <h5 class="new">New</h5>
                                    </div>
                                    <div class="f_p_text">
                                        <h5>Fossil Watch</h5>
                            ...
                            <div class="item woman shoes">
                                <div class="fillter_product_item">
                                    <div class="f_p_img">
                                        <img src="<?= get_theme_file_uri('img/product/fillter-product/f-product-3.jpg') ?>" alt="">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="from_blog_item">
                        <img class="img-fluid" src="<?= get_theme_file_uri('img/blog/from-blog/f-blog-1.jpg') ?>" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="from_blog_item">
                        <img class="img-fluid" src="<?= get_theme_file_uri('img/blog/from-blog/f-blog-2.jpg') ?>" alt="">
                        <div class="f_blog_text">
                            <h5>fashion</h5>
                            <p>Neque porro quisquam est qui dolorem ipsum</p>
                            <h6>21.09.2017</h6>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="from_blog_item">
                        <img class="img-fluid" src="<?= get_theme_file_uri('img/blog/from-blog/f-blog-3.jpg') ?>" alt="">
                        <div class="f_blog_text">
                            <h5>fashion</h5>
                            <p>Neque porro quisquam est qui dolorem ipsum</p>
                            <h6>21.09.2017</h6>
